...
def _inject_palette_theme() -> None:
    """Force the uploaded palette onto visible Streamlit components."""
...
[data-testid="stSidebar"] {
  background:
    radial-gradient(circle at 14% 0%, rgba(87, 190, 246, 0.08), transparent 28%),
    radial-gradient(circle at 86% 6%, rgba(204, 253, 80, 0.06), transparent 24%),
    var(--cc-bg) !important;
...
[data-testid="stHeader"] {
  ...
  border-bottom: 1px solid rgba(87, 190, 246, 0.16);
}
...
hr {
  border-color: rgba(87, 190, 246, 0.22) !important;
}

[data-testid="stAlert"] {
  border-radius: 12px !important;
  border: 1px solid rgba(87, 190, 246, 0.26) !important;
  border-left: 5px solid var(--cc-blue) !important;
  background: rgba(27, 45, 63, 0.78) !important;
  color: var(--cc-white) !important;
}
...
[data-testid="stAlert"]:has(svg[title="warning"]) {
  border-color: rgba(204, 253, 80, 0.34) !important;
  border-left-color: var(--cc-lime) !important;
  background: rgba(55, 62, 30, 0.86) !important;
}

.stError,
[data-testid="stAlert"]:has(svg[title="error"]) {
  border-color: rgba(235, 78, 69, 0.38) !important;
  border-left-color: var(--cc-coral) !important;
  background: rgba(77, 30, 29, 0.86) !important;
}

.stSuccess,
[data-testid="stAlert"]:has(svg[title="success"]) {
  border-color: rgba(204, 253, 80, 0.36) !important;
  border-left-color: var(--cc-lime) !important;
  background: rgba(38, 58, 35, 0.82) !important;
}

[data-testid="stExpander"] details {
  background: rgba(27, 34, 38, 0.82) !important;
  border: 1px solid rgba(87, 190, 246, 0.18) !important;
  border-radius: 12px !important;
}
...
[data-baseweb="textarea"] textarea {
  ...
  color: var(--cc-white) !important;
  border: 1px solid rgba(87, 190, 246, 0.24) !important;
...
[data-baseweb="textarea"] textarea:focus {
  ...
  box-shadow: 0 0 0 1px rgba(87, 190, 246, 0.35) !important;
}

.stButton > button {
  background: rgba(43, 52, 56, 0.96) !important;
  color: var(--cc-white) !important;
  border: 1px solid rgba(87, 190, 246, 0.30) !important;
  border-radius: 10px !important;
...
.stButton > button:hover {
  border-color: var(--cc-blue) !important;
  color: var(--cc-white) !important;
  box-shadow: 0 0 0 2px rgba(87, 190, 246, 0.14) !important;
...
.stButton > button[kind="primary"] {
  ...
  color: var(--cc-white) !important;
  border-color: rgba(235, 78, 69, 0.95) !important;
}
...
[data-testid="stFileUploader"] section {
  background: #242B30 !important;
  border: 1px dashed rgba(87, 190, 246, 0.42) !important;
  border-radius: 12px !important;
}

[data-testid="stMetric"] {
  background: rgba(27, 34, 38, 0.82) !important;
  border: 1px solid rgba(204, 253, 80, 0.24) !important;
  border-radius: 12px !important;
...
code {
  background: rgba(67, 77, 81, 0.75) !important;
  color: var(--cc-lime) !important;
...
def _render_analysis(validated: EvidenceValidationResult) -> None:
    ...
    if validated.warnings:
        with st.expander("Предупреждения проверки источников", expanded=True):
