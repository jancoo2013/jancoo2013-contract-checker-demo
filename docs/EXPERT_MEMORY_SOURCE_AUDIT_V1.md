...
| `knesset_2026_enacted_rental_security` | [Enacted 2026 Economic Programme Law, Sefer HaHukim 3510, §24 and §37](https://fs.knesset.gov.il/25/law/25_lsr_12846788.pdf) | Gazette pp. 363–364 and 370 read in a [public reproduction](https://www.law.co.il/media/computer-law/economic_plan_law_2026.pdf#page=14); *original official-domain PDF bytes not independently fetched* | Published 2026-03-31; Chapter VI takes effect **2026-09-30**; not yet operative on the packet's 2026-09-22 review date; no proof of provider licensing or cheque coverage |
...
**Dated enacted overlay:** `docs/statutory/ISRAEL_RENTAL_AND_LOAN_AMENDMENT_2026_V1.json` is the distinct statutory record. The enacted §24 replaces the definitions in §25י(a) and adds statutorily defined licensed non-bank guarantee providers in §25י(b); §37 defers Chapter VI for six months after publication. The two new source propositions remain flagged for legal-specialist review, **are not yet effective**, and are not linked as operative law to the existing synthetic cheque/note cases. The January 2026 bill stays as a separate nonbinding historical proposal.
