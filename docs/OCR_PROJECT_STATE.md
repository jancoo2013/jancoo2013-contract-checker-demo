...
Последнее обновление: 2026-07-20, после удаления ложной recognizer eligibility из сегментатора.
...
Разрешённые владельцем corrective-исключения от 2026-07-20 ограничены передачей `rejected boundary → full frame`, исправлением no-upscale, закрытием Gold/Silver leakage и удалением ложной recognizer eligibility. Они не добавляют новый OCR-компонент; после их слияния единственным следующим шагом остаётся Gold Set v0.
