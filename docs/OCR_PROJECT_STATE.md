...
Последнее обновление: 2026-07-20, после continuity audit PR 117–121 и повторного fixture smoke на текущем коде.
...
Разрешённые владельцем corrective-исключения от 2026-07-20 ограничены передачей `rejected boundary → full frame`, исправлением no-upscale, закрытием Gold/Silver leakage, удалением ложной recognizer eligibility и восстановлением согласованности state/контрактов с фактическим per-page `crop_policy`. Они не добавляют новый OCR-компонент; после их слияния единственным следующим шагом остаётся Gold Set v0.
