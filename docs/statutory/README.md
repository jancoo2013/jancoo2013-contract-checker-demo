...
## 2026 enacted rental-security amendment
...
- Commencement metadata: §37 specifies six calendar months after publication, recorded as `2026-09-30`. The source packet records that date without adding a date-driven ExpertCase gate.
...
The offline Expert Memory audit validator cross-checks source attribution and metadata; it does not decide when a rule governs a particular lease. Future edits require a new review record; do not rewrite the source-anchored 2017 snapshot.
